...
!> maximum-random cloud overlapping method
      ...
      public progcld1, progcld2, progcld3, progcld4, progcld5,          &
     &       progcld6, progclduni, diagcld1, cld_init
     ...
     &,         /3x,'     STOP at calling subroutine RHTABLE !!'/)
        ...
        if (me == 0) then
          ...
          elseif (icmphys == 5) then
            print *,'   --- GFDL Lin cloud microphysics + pdf cloud'
          else
...
!                                                                       !
!  ====================    end of description    =====================  !
      use cld_eff_rad_mod, only: cld_eff_rad
!
      implicit none
