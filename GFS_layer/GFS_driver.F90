...
!----------------
  ...
  public  GFS_setup_step          !< perform operations needed prior radiation or physics
  public  GFS_radiation_step      !< wrapper for radiation_driver (was grrad)
  public  GFS_physics_step        !< wrapper for physics_driver (was gbphys)
  public  GFS_stochastic_physics !< stochastic physics
  public  GFS_init_type       !< type to hold needed initialization variables 
...
!-------------------------------------------------------------------------
  subroutine GFS_setup_step (Model, Statein, Stateout, Sfcprop, Coupling, & 
  ...
  end subroutine GFS_setup_step


!-------------------------------------------------------------------------
! GFS_radiation_step
!-------------------------------------------------------------------------
!    calls GFS_radiation_driver
!-------------------------------------------------------------------------
  subroutine GFS_radiation_step (Model, Statein, Stateout, Sfcprop, Coupling, & 
                             Grid, Tbd, Cldprop, Radtend, Diag, IPD_Diag,  &
                             IPD_Restart)
    ...
    call radiation_driver (Model, Statein, Sfcprop, Coupling, &
                           Grid, Tbd, Cldprop, Radtend, Diag)

   end subroutine GFS_radiation_step
...
!-------------------------------------------------------------------------
  subroutine GFS_physics_step (Model, Statein, Stateout, Sfcprop, Coupling, &
    ...
    if (Model%do_sppt .or. Model%do_shum .or. &
        Model%do_skeb .or. Model%do_vc) then
      call GFS_stochastic_physics (Model, Statein, Stateout, Coupling, &
                                   Tbd, Diag)
    endif
...
!      6) performs surface data cycling via the GFS gcycle routine
!-------------------------------------------------------------------------
  subroutine GFS_stochastic_physics (Model, Statein, Stateout, Coupling, Tbd, Diag)
  ...
  end subroutine GFS_stochastic_physics
