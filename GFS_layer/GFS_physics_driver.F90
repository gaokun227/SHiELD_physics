...
!-----------------------------------------------------------------------
      ...
      if (Model%do_cosp) then
        ...
        call cosp2_driver (im, levs, ntrac, Stateout%gt0, Stateout%gq0(:,:,1), Stateout%gu0, &
            ...
            diag%cosp%tau7_bnds, &
            diag%cosp%pres7, &
            diag%cosp%pres7_bnds, &
            diag%cosp%hgt16, &
            diag%cosp%hgt16_bnds, &
            diag%cosp%atb532_perp, &
            diag%cosp%atb532, &
            diag%cosp%calipso_tau, &
            diag%cosp%cfadLidarsr532, &
            diag%cosp%clcalipso, &
            diag%cosp%lidarBetaMol532, &
            diag%cosp%SR_EDGES, &
            diag%cosp%parasolPix_refl, &
            diag%cosp%parasolGrid_refl, &
            diag%cosp%dbze94, &
            diag%cosp%cfadDbze94, &
            diag%cosp%cltisccp, &
            ...
            diag%cosp%tauisccp, &
            diag%cosp%albisccp, &
            diag%cosp%boxtauisccp, &
            diag%cosp%boxptopisccp, &
            diag%cosp%clisccp, &
            diag%cosp%clMISR, &
            ...
            diag%cosp%iwpmodis, &
            diag%cosp%clmodis, &
            diag%cosp%modis_Optical_Thickness_vs_ReffICE, &
            diag%cosp%modis_Optical_Thickness_vs_ReffLIQ, &
            diag%cosp%clcalipso2, &
            diag%cosp%cltlidarradar, &
            diag%cosp%clcalipsoice, &
            diag%cosp%clcalipsoliq, &
            diag%cosp%clcalipsoun, &
            ...
            diag%cosp%clcalipsotmp, &
            diag%cosp%clcalipsotmpice, &
            diag%cosp%clcalipsotmpliq, &
            diag%cosp%clcalipsotmpun, &
            diag%cosp%SR_BINS_list, &
            diag%cosp%bnds, &
            diag%cosp%loc, &
            diag%cosp%lev, &
            diag%cosp%levStat, &
            diag%cosp%cosp_scol, &
            diag%cosp%PARASOL_NREFL_list, &
            diag%cosp%cloudsat_DBZE_BINS_list, &
            diag%cosp%REICE_MODIS, &
            diag%cosp%RELIQ_MODIS, &
            diag%cosp%clopaquecalipso, &
            diag%cosp%clthincalipso, &
            diag%cosp%clzopaquecalipso, &
            diag%cosp%clcalipsoopaque, &
            diag%cosp%clcalipsothin, &
            diag%cosp%clcalipsozopaque, &
            diag%cosp%clcalipsoopacity, &
            ...
            diag%cosp%clgrLidar532, &
            diag%cosp%lidarBetaMol532gr, &
            diag%cosp%cfadLidarsr532gr, &
            diag%cosp%atb532gr, &
            diag%cosp%SR_BINS_GR, &
            diag%cosp%SR_EDGES_GR, &
            diag%cosp%cllatlid, &
            diag%cosp%clmatlid, &
            diag%cosp%clhatlid, &
            diag%cosp%cltatlid, &
            diag%cosp%clatlid, &
            diag%cosp%lidarBetaMol355, &
            diag%cosp%cfadLidarsr355, &
            diag%cosp%atb355, &
            diag%cosp%SR_BINS_ATLID, &
            diag%cosp%SR_EDGES_ATLID, &
            ...
            diag%cosp%ncfodd2, &
            diag%cosp%ncfodd3, &
            diag%cosp%CFODD_NDBZE_list, &
            diag%cosp%CFODD_NICOD_list)
