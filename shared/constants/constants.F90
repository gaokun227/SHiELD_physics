...
!rabreal, public, parameter :: RVGAS = 461.50 
!rabreal, public, parameter :: HLV = 2.500e6   
!rabreal, public, parameter :: HLF = 3.34e5   
!rabreal, public, parameter :: HLS = HLV + HLF
!rabreal, public, parameter :: TFREEZE = 273.16    
...
real, public, parameter :: EPSLN   = 1.0e-15

!rabreal, public, parameter :: STEFAN  = 5.6734e-8 
!rabreal, public, parameter :: EPSLN   = 1.0e-40
!rabreal, public, parameter :: PI      = 3.14159265358979323846
